        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg">
              Take control of your finances with our intuitive tools for budgeting, expense tracking, and goal planning. Start your journey to financial freedom today.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Button className="text-lg px-8 py-6 bg-finflow-blue hover:bg-blue-800">
            ...
            <div className="mt-10 flex items-center text-gray-600">
              <div className="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=50&h=50&auto=format&fit=facearea&facepad=2&q=80" className="w-8 h-8 rounded-full border-2 border-white" />
                <img src="https://images.unsplash.com/photo-1521119989659-a83eee488004?w=50&h=50&auto=format&fit=facearea&facepad=2&q=80" className="w-8 h-8 rounded-full border-2 border-white" />
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=50&h=50&auto=format&fit=facearea&facepad=2&q=80" className="w-8 h-8 rounded-full border-2 border-white" />
              </div>
